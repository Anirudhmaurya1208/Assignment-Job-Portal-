...
function Home() {
  const isDarkMode = useStore((state) => state.isDarkMode);
  const currentUser = useStore((state) => state.currentUser); // Assuming user information is stored here
  ...
  const handlePostJobClick = () => {
    if (!currentUser) {
      ...
      // Redirect to the page for posting jobs (CRUD operations)
      navigate('/post-job'); // Make sure you have a route for this
    } else {
      // Optionally, handle if the user is logged in but not an employer
